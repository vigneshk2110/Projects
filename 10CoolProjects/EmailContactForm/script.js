...
var phoneError = document.getElementById("phone-error").value;
var emailError = document.getElementById("email-error").value;
var messageError = document.getElementById("message-error").value;
var submitError = document.getElementById("submit-error").value;
